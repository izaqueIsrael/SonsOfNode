    ...
    <>
      <section className="about">
        ...
        <div className="about__container">
          ...
          <p className="text article__text">
            Acreditamos que cada aluno é único e merece uma educação que
            reconheça e atenda às suas necessidades individuais. Por isso,
            mergulhamos fundo nos dados para entender onde estão os desafios e
            as oportunidades. Nossa missão é usar a tecnologia, especialmente a
            Inteligência Artificial, para moldar soluções educacionais que não
            apenas preencham lacunas, mas também inspirem e capacitem a próxima
            geração.
          </p>
        </div>
      </section>
